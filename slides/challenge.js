...
(function () {
  ...
  var I18N = {
    ...
    hk: {
      ...
      claimFail: { task_not_done: '今日任務還沒完成', already_claimed: '今日已領過了', expired: '伴學計劃已結束', disqualified: '伴學資格已被取消', upstream: '網絡開小差了，稍後再試' },
      ...
      dqTitle: '伴學資格已取消',
      dqBody: '經核查存在刷課行為，伴學資格已取消。已投入的米粒不予退還，已領取的補貼不受影響。<br>如認為是誤判，進交流羣找洛小山申訴即可。',
      dqWhy: '判定依據',
      dqAppeal: '我要申訴',
      settleFull: '全勤達成！',
      settleEnd: '伴學計劃結束',
